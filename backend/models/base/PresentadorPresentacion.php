 ...
 */
class PresentadorPresentacion extends \yii\db\ActiveRecord
{
    ...
    /**
     * @inheritdoc
     * @return \backend\models\PresentadorPresentacionQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \backend\models\PresentadorPresentacionQuery(get_called_class());
    }
}
