...
class Presentador extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['afiliacion_id', 'imagen_id', 'Nombre', 'Correo', 'Descripcion'], 'required'],
            [['afiliacion_id', 'imagen_id'], 'integer'],
            [['Descripcion'], 'string'],
            ...
            [['imagen_id'], 'exist', 'skipOnError' => true, 'targetClass' => Imagen::className(), 'targetAttribute' => ['imagen_id' => 'id']],
        ];
    }
