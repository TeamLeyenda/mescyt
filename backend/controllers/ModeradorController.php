...
use backend\models\ModeradorSearch;
...
class ModeradorController extends Controller
{
        ...
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    [
                        'allow' => true,
                        'actions' => ['index', 'view', 'create', 'update', 'delete', 'pdf', 'save-as-new', 'add-sala', 'add-user'],
                        'roles' => ['@']
                    ],
                    [
                        'allow' => false
    ...
    public function actionView($id)
    {
        ...
        $providerSala = new \yii\data\ArrayDataProvider([
            'allModels' => $model->salas,
        ]);
    ...
    /**
     * 
     * Export Moderador information into PDF format.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
    * Creates a new Moderador model by another data,
    ...
    * @return mixed
    */
    public function actionAddSala()
    {
        if (Yii::$app->request->isAjax) {
            $row = Yii::$app->request->post('Sala');
            if((Yii::$app->request->post('isNewRecord') && Yii::$app->request->post('_action') == 'load' && empty($row)) || Yii::$app->request->post('_action') == 'add')
                $row[] = [];
            return $this->renderAjax('_formSala', ['row' => $row]);
        } else {
            throw new NotFoundHttpException(Yii::t('app', 'The requested page does not exist.'));
        }
    }
