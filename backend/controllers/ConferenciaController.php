...
use backend\models\ConferenciaSearch;
...
class ConferenciaController extends Controller
{
        ...
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    [
                        'allow' => true,
                        'actions' => ['index', 'view', 'create', 'update', 'delete', 'pdf', 'save-as-new', 'add-presentador-conferencia'],
                        'roles' => ['@']
                    ],
                    [
                        'allow' => false
    ...
    /**
     * 
     * Export Conferencia information into PDF format.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
    * Creates a new Conferencia model by another data,
