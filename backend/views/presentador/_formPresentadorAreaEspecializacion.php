        ...
        'del' => [
            ...
            'value' => function($model, $key) {
                return
                    ...
                    Html::a('<i class="glyphicon glyphicon-trash"></i>', '#', ['title' =>  Yii::t('app', 'Delete'), 'onClick' => 'delRowPresentadorAreaEspecializacion(' . $key . '); return false;', 'id' => 'presentador-area-especializacion-del-btn']);
            },
        ],
    ],
    'gridSettings' => [
