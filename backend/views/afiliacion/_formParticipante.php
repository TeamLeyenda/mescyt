<div class="form-group" id="add-participante">
<?php
...
echo TabularForm::widget([
    ...
    'gridSettings' => [
        'panel' => [
            ...
            'before' => false,
            'footer' => false,
            'after' => Html::button('<i class="glyphicon glyphicon-plus"></i>' . Yii::t('app', 'Add Participante'), ['type' => 'button', 'class' => 'btn btn-success kv-batch-create', 'onClick' => 'addRowParticipante()']),
        ]
    ]
]);
echo  "    </div>\n\n";
