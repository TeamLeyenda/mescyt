...
/* @var $searchModel backend\models\ConferenciaSearch */
...
$this->title = Yii::t('app', 'Conferencias');
...
<div class="conferencia-index">
    ...
    <p>
        <?= Html::a(Yii::t('app', 'Create Conferencia'), ['create'], ['class' => 'btn btn-success']) ?>
    ...
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'Congreso', 'id' => 'grid-conferencia-search-congreso_id']
            ],
        'Titulo',
        'Institucion',
        'Area_Tematica',
